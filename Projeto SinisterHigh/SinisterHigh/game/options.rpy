...
define config.name = _("SinisterHigh")
...
define build.name = "SinisterHigh"
...
define config.main_menu_music = "musica de menu.mp3"
...
define config.save_directory = "SinisterHigh-1689803890"
